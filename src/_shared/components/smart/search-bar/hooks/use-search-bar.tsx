...
export default function useSearchBar() {
  const [ segmentOpenStatus, setSegmentOpenStatus ] = useState<{ [id: SegmentIdType]: boolean }>({
    [Segment.LOCATION]: false,
    [Segment.TIME]: false,
    [Segment.LEVEL]: false,
  });

  const isAnySegmentOpen = segmentOpenStatus[Segment.LOCATION] || segmentOpenStatus[Segment.TIME] || segmentOpenStatus[Segment.LEVEL];
  ...
  function getSegmentDisplayStatus(segmentId: SegmentIdType): SegmentDisplayStatus {
